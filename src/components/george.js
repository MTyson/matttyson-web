			...
			<div>
			   <div className="flip-back" style={{
				...
				border: `5px double #000000`, borderRadius: `10px`, height:'444px', width:`301px`, textAlign:'center'}}>
				  <p>One of the great creative minds of the 20th century, George Harrison founded Dark Horse Records in 1974.</p>
				  <p>Harrison united music and spirituality, East and West. In so doing, he forever expanded the possibilities in this world.</p>
				  <p>He was a member of <a href="#" onClick={(e)=>{onNav('beatles')}}>The Beatles</a> and a devotee of <a href="#" onClick={(e)=>{onNav('yogananda')}}>Yogananda</a>.</p>
				  <p>He fought <a href="#" onClick={(e)=>{onNav('steve')}}>Steve Jobs</a> and <a href="#" onClick={(e)=>{onNav('apple-computer')}}>Apple Computer</a> over rights to <a href="#" onClick={(e)=>{onNav('yogananda')}}>Apple Records</a>.</p>
				</div>
			</div>
        </FlipCard>
        </div>
